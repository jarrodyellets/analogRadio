$(document).ready(function(){
	const btnSound = new Audio("http://www.jarrodyellets.com/sounds/radioButton.mp3");
	...
	const clearStatic = new Audio("http://www.jarrodyellets.com/sounds/clearStatic.mp3");
	...
	let turnRight;
	let power = false;
	const apiKey = "abc123[QqD17exJYoMo01mH4WyTeWIMr4k6rT8AVnOdtR7HfCdPfWbe6w9dMWHFuncvozQ9k1rkrPlbyckkDYYy9fBMjUibASY3pUuUVv8fmFppp2s9DKFEyXmAhTY7aawzO7hm]";
	const apiUrl = "http://streamfinder.com/api/"
	...
	$("#left-knob").mouseup(function(){
	 	clearInterval(turnLeft);
	});

	$("#right-knob").mousedown(function(){
		posNum = $(".needle").css("left");
		needlePos = Number(posNum.slice(0, (posNum.length - 2)));
